...
type Ethash struct {
	...
	// miner's history block number in the repu window
	historyBlockNumber   map[common.Address]uint64
	lastMinedBlockNumber map[common.Address]*big.Int
}
...
func New(config Config, notify []string, noverify bool) *Ethash {
	...
	ethash := &Ethash{
		...
		historyBlockNumber:   make(map[common.Address]uint64),
		lastMinedBlockNumber: make(map[common.Address]*big.Int),
	}
